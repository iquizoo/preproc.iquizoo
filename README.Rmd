...
[![Codecov test coverage](https://codecov.io/gh/iquizoo/preproc.iquizoo/graph/badge.svg)](https://app.codecov.io/gh/iquizoo/preproc.iquizoo)
...
Or you can install the stable version from [r-universe](https://iquizoo.r-universe.dev/) with:
...
This package is best used in company with [tarflow.iquizoo](https://github.com/iquizoo/tarflow.iquizoo) package. Read the [documentation](https://iquizoo.github.io/tarflow.iquizoo/) there.
